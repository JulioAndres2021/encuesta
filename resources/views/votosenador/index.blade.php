                                    ...
                                    <div class="col-lg-6 col-12 mb-4 mb-lg-0 mt-3">
                                        <div class="custom-block d-flex">
                                            ...
                                            <div class="d-flex flex-column ms-auto text-center">
                                                ...
                                                <a href="#senador_modal" class="badge ms-auto valor_id_senador" data-bs-toggle="modal" data-bs-target="#senador_modal" data-id="{{ $row->id }}" data-nombre="{{ $row->nombre }}" data-link="{{ $row->link }}"><i class="bi-heart"></i></a>
