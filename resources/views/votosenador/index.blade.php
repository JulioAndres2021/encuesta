...
<head>
    ...
    <title>Candidato a Senador</title>
    <!--FONT-AWESONE-->
...
<body>
    ...
    <section>
                                    ...
                                    <div class="col-lg-6 col-12 mb-4 mb-lg-0 mt-3">
                                        <div class="custom-block d-flex">
                                            ...
                                            <div class="d-flex flex-column ms-auto text-center">
                                                <a href="#senador_modal" class="badge ms-auto valor_id_senador"
                                                    data-bs-toggle="modal" data-bs-target="#senador_modal" data-id="{{ $row->id }}" data-nombre="{{ $row->nombre }}" data-link="{{ $row->link }}>
                                                    <i class="bi-heart"></i>
                                                </a>
        ...
        <div class="card-body contenido_tabla_senador">
    ...
    <div class="container">
        ...
        {{-- MODALES --}}
        <div class="modal fade" id="senador_modal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        ...
                        <div class="modal-body">
                            <div class="card">
                                <div class="card-body">
                                    <h3 id="ip-encontrada">
                                    <div class="mb-1">
                                        {{-- <img id="imagen_voto_candidato" src="" class="custom-block-image img-fluid"
                                            alt=""> --}}
                                        {{-- <label class="mb-3">ID Candidadato</label> --}}
                                        <input type="hidden" class="form-control" name="senador_id" id="id_del_candidato">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $(".contenido_tabla_senador").hide();//escondemos la tabla senador
                            ...
                            } else
                            {
                                if (respuesta.data[0].ip == ip ) {
                                    ...
                                    ({
                                        position: "top-end",
                                        icon: "error",
                                        title: "Ya votaste a Senadores.!",
                                        showConfirmButton: false,
                                        timer: 1500
                                });

                                    //esconemos el modal
                                    $('#senador_modal').modal('hide');
                                    //$('#search_list').val('');
            ...
            //Obtengo el id cuando selecciono un candidato a VOTAR
                ...
                editButtons.forEach(function(item, idx) {
                    item.addEventListener('click', function() {
                        ...
                        let linkcandidato = $(this).attr('data-link')
                        //console.log(candidato);
                        //console.log(linkcandidato);
                        ...
                        */
                        ...
                        //ponemos la imagen del candidato
                        //$('#imagen_voto_candidato').attr("src", linkcandidato);
        ...
        function registrar_votos() {
            ...
            Swal.fire({
                ...
                preConfirm: () => {
                    ...
                    return fetch('{{ route('senador.registrar') }}', {
                        method: "POST",
                        body: formData,
                        headers: {
